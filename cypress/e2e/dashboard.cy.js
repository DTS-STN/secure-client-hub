    ...
    cy.wrap(cardTitles).each((cardTitle) => {
      ...
      cy.get('@currentCard').within(() => {
        ...
        cy.get('[data-cy="task-group-list"]')
          ...
          .find('[data-cy="task-link"] a[href="/en/profile-and-preferences"]')
          .click()
        cy.location('pathname', { timeout: 10000 }).should('equal', '/en/profile-and-preferences')
  ...
  it('Iterates through EI, CPP and OAS task lists for Profile page FR', () => {
    ...
    cy.wrap(cardTitles).each((cardTitle) => {
      ...
      cy.get('@currentCard').within(() => {
        ...
        cy.get('[data-cy="task-group-list"]')
          .parents('[data-cy="Task"]')
          .find('[data-cy="task-link"] a[href="/fr/profil-et-preferences"]')
          .click()
        cy.location('pathname', { timeout: 10000 }).should('equal', '/fr/profil-et-preferences')
