    ...
    cy.wrap(cardTitles).each((cardTitle) => {
      ...
      cy.get('@currentCard').within(() => {
        ...
        cy.get('[data-cy="task-group-list"]')
          ...
          .find('[data-cy="task-link"] a[href="/en/personal-information-by-benefit"]')
          .click()
        cy.location('pathname', { timeout: 10000 }).should('equal', '/en/personal-information-by-benefit')
  ...
  it('Iterates through EI, CPP and OAS task lists for Profile page FR', () => {
    ...
    cy.wrap(cardTitles).each((cardTitle) => {
      ...
      cy.get('@currentCard').within(() => {
        ...
        cy.get('[data-cy="task-group-list"]')
          .parents('[data-cy="Task"]')
          .find('[data-cy="task-link"] a[href="/fr/renseignements-personnels-par-prestation"]')
          .click()
        cy.location('pathname', { timeout: 10000 }).should('equal', '/fr/renseignements-personnels-par-prestation')
