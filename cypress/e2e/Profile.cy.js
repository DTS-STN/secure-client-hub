...
describe('Validate Profile page', () => {
  it.skip('Validate Profile Page header in English', () => {
  ...
  it.skip('validate the "My dashboard" click on Profile page goes to dashboard page', () => {
  ...
  it.skip('validate the "My dashboard" click from profile page goes to dashboard page', () => {
    securityPo.breadcrumbs().click()
    cy.url().should('contains', '/home')
    dashboardPo
      .dashboardHeader()
  ...
  it.skip('Validate that the Card placeholder is present on Profile Page', () => {
  ...
  it.skip('Validate that the "Looking for" section is present on Profile Page', () => {
  ...
  it.skip('Validate the "Back to Dashboard" click navigates to dashboard page', () => {
  ...
  it.skip('Validate the "Looking for Security Settings" and button text text in English', () => {
  ...
  it.skip('Validate that the Task List is Present for each card on profile page', () => {
