...
const CollapseAlert = ({
  ...
  return (
    <li id={id} className={`relative pl-4 sm:pl-6 ${white_BG} ${className}`}>
      <div
      ...
      >
        <details
          className="my-2 border-spacing-1 rounded border border-gray-40"
          open
        >
          <summary className=" ml-2 flex list-none justify-between py-1 font-display text-2xl font-bold leading-[26px] text-deep-blue-dark ">
            {alertHeading}
            <span>
              {!alertIsOpen ? (
                <FontAwesomeIcon
